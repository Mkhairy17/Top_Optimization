...
U = Displacement_solver_density(Amat,rho_old,nx,ny,a,b,P); %penalized stiffness matrix
el = 1;
for j = 1:ny
    for i = 1:nx
        [eigen_vec,phi] = cal_C_element(Amat,i,j,el,ny,U,KE_A11,KE_A12,KE_A16,KE_A26,KE_A22,KE_A66,rho_old,P);
...
% Sensitivities
[rho_filtered,bn,C] = Filtering_subroutine (Amat,U,rho_old,F,nx,ny,a,b,P);
