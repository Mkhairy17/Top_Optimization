...
[Amat_new_density,U1,U2,U3,U4,U5] = xval_Amat(xval_new,Q,Ne);
U_penalized = Displacement_solver_density(Amat_new_density,rho_old,nx,ny,a,b,P); %Penalized stiffness values
el = 1;
for j = 1:ny
    parfor i = 1:nx
        [eigen_vec,phi] = cal_C_element(Amat_new_density,i,j,el,ny,U_penalized,KE_A11,KE_A12,KE_A16,KE_A26,KE_A22,KE_A66);
         vv1 = eigen_vec(:,1);
        vv2 = eigen_vec(:,2);
        vv3 = eigen_vec(:,3);
