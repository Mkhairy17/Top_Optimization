...
lmiterm([-1 4 1 0], real(vv1(1)));   %V1'
lmiterm([-1 4 2 0], real(vv1(2)));   %V1'
lmiterm([-1 4 3 0], real(vv1(3)));   %V1'
lmiterm([-1 4 4 alpha1],1,1);   %alfa1
lmiterm([-1 1 4 0],real(vv1(1)));   %V1'
lmiterm([-1 2 4 0],real(vv1(2)));   %V1'
lmiterm([-1 3 4 0],real(vv1(3)));   %V1'
% A11 =  U1 + U2.*V1 + U3.*V3;
...
lmiterm([-2 4 1 0], real(vv2(1)));   %V1'
lmiterm([-2 4 2 0], real(vv2(2)));   %V1'
lmiterm([-2 4 3 0], real(vv2(3)));   %V1'
lmiterm([-2 4 4 alpha2],1,1);   %alfa1
lmiterm([-2 1 4 0],real(vv2(1)));   %V1'
lmiterm([-2 2 4 0],real(vv2(2)));   %V1'
lmiterm([-2 3 4 0],real(vv2(3)));   %V1'
...
lmiterm([-3 4 1 0], real(vv3(1)));   %V1'
lmiterm([-3 4 2 0], real(vv3(2)));   %V1'
lmiterm([-3 4 3 0], real(vv3(3)));   %V1'
lmiterm([-3 4 4 alpha3],1,1);   %alfa1
lmiterm([-3 1 4 0],real(vv3(1)));   %V1'
lmiterm([-3 2 4 0],real(vv3(2)));   %V1'
lmiterm([-3 3 4 0],real(vv3(3)));   %V1'
