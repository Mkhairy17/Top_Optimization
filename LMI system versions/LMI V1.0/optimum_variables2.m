function xval_opt = optimum_variables2 (U1,U2,U3,U4,U5,vv1,vv2,vv3)
c = [1 1 1 0 0 0 0]';
setlmis([]);
alpha1=lmivar(2,[1,1]); 
alpha2=lmivar(2,[1,1]);
...
lmiterm([-2 4 1 0], vv2(1)/2);   %V1'
lmiterm([-2 4 2 0], vv2(2)/2);   %V1'
lmiterm([-2 4 3 0], vv2(3)/2);   %V1'
lmiterm([-2 4 4 alpha2],1,1);   %alfa1
lmiterm([-2 1 4 0],vv2(1)/2);   %V1'
lmiterm([-2 2 4 0],vv2(2)/2);   %V1'
lmiterm([-2 3 4 0],vv2(3)/2);   %V1'
...
lmiterm([-2 1 3 V2], 0 , 1);  % U2.*V2/2
lmiterm([-2 1 3 V4], 0 , 1);  % U3.*V4

%A26 =  U2.*V2/2 - U3.*V4;
% lmiterm([-2 2 3 V2],U2/2 , 1);  % U2.*V2/2
% lmiterm([-2 2 3 V4],U3,-1);  % U3.*V4

lmiterm([-2 2 3 V2],0, 1);  % U2.*V2/2
lmiterm([-2 2 3 V4],0,-1);  % U3.*V4
...
lmiterm([-3 4 1 0], vv3(1)/2);   %V1'
lmiterm([-3 4 2 0], vv3(2)/2);   %V1'
lmiterm([-3 4 3 0], vv3(3)/2);   %V1'
lmiterm([-3 4 4 alpha3],1,1);   %alfa1
lmiterm([-3 1 4 0],vv3(1)/2);   %V1'
lmiterm([-3 2 4 0],vv3(2)/2);   %V1'
lmiterm([-3 3 4 0],vv3(3)/2);   %V1'
...
lmiterm([-3 1 3 V2], 0, 1);  % U2.*V2/2
lmiterm([-3 1 3 V4], 0, 1);  % U3.*V4

%A26 =  U2.*V2/2 - U3.*V4;
% lmiterm([-3 2 3 V2], U2/2, 1);  % U2.*V2/2
% lmiterm([-3 2 3 V4], U3,-1);  % U3.*V4

lmiterm([-3 2 3 V2],0, 1);  % U2.*V2/2
lmiterm([-3 2 3 V4], 0,-1);  % U3.*V4
...
lmiterm([-4 1 2 V2], 0,1);   % 4V2 
lmiterm([-4 1 2 V4], 0,1);   % 2V4
...
lmiterm([-4 2 3 V2], 0,1);   % 4 V2 
lmiterm([-4 2 3 V4], 0,-1);   % -2 V4
...
lmiterm([-4 2 1 V2], 0,1);   % 4V2 
lmiterm([-4 2 1 V4], 0,1);   % 2V4
...
lmiterm([-4 3 2 V2],0,1);   % 4 V2 
lmiterm([-4 3 2 V4],0,1);   % -2 V4
